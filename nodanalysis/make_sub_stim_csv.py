...
for i, sub in enumerate(['sub-{:02d}'.format(_) for _ in [1,2,3,5,6,9,10]]):
    ...
    act_path = f'/nfs/z1/userhome/GongZhengXin/NVP/NaturalObject/data/bold/derivatives/beta/{sub}'
    ...
    save_path = '/nfs/z1/userhome/GongZhengXin/NVP/NaturalObject/data/code/nodanalysis/sub_stim_csv'
