...
reliability_path = pjoin(result_path, f'coco-zscore-{clean_code}_withinsub_reliability.dtseries.nii')
if not os.path.exists(reliability_path):
    ...
    save_ciftifile(reliability_map_save, pjoin(result_path, f'coco-zscore-{clean_code}_withinsub_reliability.dtseries.nii'))
else:
