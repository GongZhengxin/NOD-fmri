...
with open(pjoin(os.getcwd(), 'fMRIData/info/processlist.tsv'),'r') as info:
...
compressed_data_folder = 'fMRIData/orig' # targzFile is where all .tar.gz data file stored
dicom_folder, nifiti_folder = 'fMRIData/dicom', 'fMRIData/nifti' # where store the Dcom date & Nifiti data
